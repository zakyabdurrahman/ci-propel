 ...
 *
 *
 * @package    propel.generator.News.Base
 */
abstract class News implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\News\\Map\\NewsTableMap';
    ...
    /**
     * Initializes internal state of News\Base\News object.
     */
    ...
    public function setHeadline($v)
    {
        ...
        if ($this->headline !== $v) {
            $this->headline = $v;
            $this->modifiedColumns[NewsTableMap::COL_HEADLINE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : NewsTableMap::translateFieldName('Headline', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = NewsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\News\\News'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_HEADLINE)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(NewsTableMap::COL_HEADLINE)) {
            $criteria->add(NewsTableMap::COL_HEADLINE, $this->headline);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \News\News (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \News\News Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */

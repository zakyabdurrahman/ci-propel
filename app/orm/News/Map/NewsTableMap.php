...
class NewsTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'News.Map.NewsTableMap';
     ...
     */
    public const OM_CLASS = '\\News\\News';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'News.News';
     ...
     */
    public const COL_ID = 'news.id';

    /**
     * the column name for the headline field
     */
    public const COL_HEADLINE = 'news.headline';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Headline', ],
        self::TYPE_CAMELNAME     => ['id', 'headline', ],
        self::TYPE_COLNAME       => [NewsTableMap::COL_ID, NewsTableMap::COL_HEADLINE, ],
        self::TYPE_FIELDNAME     => ['id', 'headline', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Headline' => 1, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'headline' => 1, ],
        self::TYPE_COLNAME       => [NewsTableMap::COL_ID => 0, NewsTableMap::COL_HEADLINE => 1, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'headline' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'headline' => 'HEADLINE',
        'news.headline' => 'HEADLINE',
        'NewsTableMap::COL_HEADLINE' => 'HEADLINE',
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\News\\News');
        $this->setPackage('News');
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NewsTableMap::COL_HEADLINE);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(NewsTableMap::COL_HEADLINE);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.headline');
        }
    }
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \News\News) { // it's a model object
